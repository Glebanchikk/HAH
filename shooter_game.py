...
win_width = 700
win_height = 500
display.set_caption('_____________________')
...
win = font1.render('NEVER GONNA GIVE YOU UP\n NEVER GONNA LET YOU DOWN', True, (0, 255, 0))
lose = font1.render('DEAD INSIDE', True, (255, 0, 0))
    ...
    if not finish:
        ...
        if rel_time == True:
            ...
            if now_time - last_time < 3:
                reload_text = font2.render('Патроны ёпта!', 1, (255, 0, 0))
